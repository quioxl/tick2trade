...
add wave -noupdate -divider HDP
add wave -noupdate /tb/host_if/clk
add wave -noupdate /tb/host_if/reset_n
add wave -noupdate /tb/host_if/in_config_valid
add wave -noupdate /tb/host_if/in_config_data
add wave -noupdate /tb/host_if/in_config_accept
add wave -noupdate -expand /tb/DUT/hpb_i/host_msg_map
add wave -noupdate -divider SRCB_IF
add wave -noupdate /tb/DUT/srcb_hpb_if/clk
add wave -noupdate /tb/DUT/srcb_hpb_if/reset_n
add wave -noupdate /tb/DUT/srcb_hpb_if/hpb_wr_addr
add wave -noupdate /tb/DUT/srcb_hpb_if/hpb_wr_data
add wave -noupdate /tb/DUT/srcb_hpb_if/hpb_wr_byte_en
add wave -noupdate /tb/DUT/srcb_hpb_if/hpb_wr_req
add wave -noupdate /tb/DUT/srcb_hpb_if/rcb_wr_done
add wave -noupdate -divider PRCB_IF
add wave -noupdate /tb/DUT/prcb_hpb_if/clk
add wave -noupdate /tb/DUT/prcb_hpb_if/reset_n
add wave -noupdate /tb/DUT/prcb_hpb_if/hpb_wr_addr
add wave -noupdate /tb/DUT/prcb_hpb_if/hpb_wr_data
add wave -noupdate /tb/DUT/prcb_hpb_if/hpb_wr_byte_en
add wave -noupdate /tb/DUT/prcb_hpb_if/hpb_wr_req
add wave -noupdate /tb/DUT/prcb_hpb_if/rcb_wr_done
add wave -noupdate /tb/DUT/prcb_i/clk
add wave -noupdate /tb/DUT/prcb_i/reset_n
add wave -noupdate /tb/DUT/prcb_i/t2t_rd_addr
add wave -noupdate /tb/DUT/prcb_i/sef_read
add wave -noupdate /tb/DUT/prcb_i/sef_inmsg
add wave -noupdate /tb/DUT/prcb_i/rcb_data
add wave -noupdate /tb/DUT/prcb_i/ram_addr
add wave -noupdate /tb/DUT/prcb_i/accept_write_req
add wave -noupdate /tb/DUT/prcb_i/ignore_hpb_wr_req_q
add wave -noupdate /tb/DUT/prcb_i/stall_host_write
add wave -noupdate /tb/DUT/prcb_i/RAM
add wave -noupdate -divider VRCB_IF
add wave -noupdate /tb/DUT/vrcb_hpb_if/clk
add wave -noupdate /tb/DUT/vrcb_hpb_if/reset_n
add wave -noupdate /tb/DUT/vrcb_hpb_if/hpb_wr_addr
add wave -noupdate /tb/DUT/vrcb_hpb_if/hpb_wr_data
add wave -noupdate /tb/DUT/vrcb_hpb_if/hpb_wr_byte_en
add wave -noupdate /tb/DUT/vrcb_hpb_if/hpb_wr_req
add wave -noupdate /tb/DUT/vrcb_hpb_if/rcb_wr_done
add wave -noupdate -divider ORCB_IF
add wave -noupdate /tb/DUT/orcb_hpb_if/clk
add wave -noupdate /tb/DUT/orcb_hpb_if/reset_n
add wave -noupdate /tb/DUT/orcb_hpb_if/hpb_wr_addr
add wave -noupdate /tb/DUT/orcb_hpb_if/hpb_wr_data
add wave -noupdate /tb/DUT/orcb_hpb_if/hpb_wr_byte_en
add wave -noupdate /tb/DUT/orcb_hpb_if/hpb_wr_req
add wave -noupdate /tb/DUT/orcb_hpb_if/rcb_wr_done
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {208608 ps} 0}
...
update
WaveRestoreZoom {94495 ps} {310817 ps}
