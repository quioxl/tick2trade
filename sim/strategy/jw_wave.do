...
add wave -noupdate -group {Feed Interface} /tb/feed_if/clk
add wave -noupdate -group {Feed Interface} /tb/feed_if/reset_n
add wave -noupdate -group {Feed Interface} /tb/feed_if/ready
add wave -noupdate -group {Feed Interface} /tb/feed_if/valid
add wave -noupdate -group {Feed Interface} /tb/feed_if/startofpacket
add wave -noupdate -group {Feed Interface} /tb/feed_if/endofpacket
add wave -noupdate -group {Feed Interface} /tb/feed_if/data
add wave -noupdate -group {Feed Interface} /tb/feed_if/empty
add wave -noupdate -group {Feed Interface} /tb/feed_if/error
...
add wave -noupdate -expand -group {Host Interface} -radix Rams -childformat {{(7) -radix Rams} {(6) -radix Rams} {(5) -radix Rams} {(4) -radix Rams} {(3) -radix Rams} {(2) -radix Rams} {(1) -radix Rams} {(0) -radix Rams}} -subitemconfig {{/tb/host_if/in_config_data[247]} {-radix Rams} {/tb/host_if/in_config_data[246]} {-radix Rams} {/tb/host_if/in_config_data[245]} {-radix Rams} {/tb/host_if/in_config_data[244]} {-radix Rams} {/tb/host_if/in_config_data[243]} {-radix Rams} {/tb/host_if/in_config_data[242]} {-radix Rams} {/tb/host_if/in_config_data[241]} {-radix Rams} {/tb/host_if/in_config_data[240]} {-radix Rams}} /tb/host_if/host_ram
...
add wave -noupdate -group {Order Interface} /tb/order_if/clk
add wave -noupdate -group {Order Interface} /tb/order_if/reset_n
add wave -noupdate -group {Order Interface} /tb/order_if/data
add wave -noupdate -group {Order Interface} /tb/order_if/ready
add wave -noupdate -group {Order Interface} /tb/order_if/valid
add wave -noupdate -group HDP /tb/host_if/clk
add wave -noupdate -group HDP /tb/host_if/reset_n
add wave -noupdate -group HDP /tb/host_if/in_config_valid
add wave -noupdate -group HDP /tb/host_if/in_config_data
add wave -noupdate -group HDP /tb/host_if/in_config_accept
add wave -noupdate -group HDP -expand /tb/DUT/hpb_i/host_msg_map
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/clk
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/reset_n
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/hpb_wr_addr
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/hpb_wr_data
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/hpb_wr_byte_en
add wave -noupdate -group SRCB_IF /tb/DUT/srcb_hpb_if/hpb_wr_req
...
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_hpb_if/hpb_wr_addr
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_hpb_if/hpb_wr_data
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_hpb_if/hpb_wr_byte_en
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_hpb_if/hpb_wr_req
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_hpb_if/rcb_wr_done
add wave -noupdate -expand -group PRCB_IF /tb/DUT/prcb_i/clk
...
add wave -noupdate -group VRCB_IF /tb/DUT/vrcb_hpb_if/hpb_wr_data
add wave -noupdate -group VRCB_IF /tb/DUT/vrcb_hpb_if/hpb_wr_byte_en
add wave -noupdate -group VRCB_IF /tb/DUT/vrcb_hpb_if/hpb_wr_req
add wave -noupdate -group VRCB_IF /tb/DUT/vrcb_hpb_if/rcb_wr_done
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/clk
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/reset_n
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/hpb_wr_addr
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/hpb_wr_data
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/hpb_wr_byte_en
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/hpb_wr_req
add wave -noupdate -group ORCB_IF /tb/DUT/orcb_hpb_if/rcb_wr_done
add wave -noupdate -group RAMS /tb/DUT/srcb_i/RAM
add wave -noupdate -group RAMS /tb/DUT/prcb_i/RAM
